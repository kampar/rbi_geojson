...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="rbi100">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="183,255,50,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="rbi100"/>
  ...
  <aliases>
    <alias field="rbi100" index="0" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="rbi100"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="rbi100" expression=""/>
